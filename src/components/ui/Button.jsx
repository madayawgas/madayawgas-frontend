export default function Button({ 
  ...
  const variants = {
    ...
    yellow: "bg-[#FFDF2D] text-[#0B4A6E] px-4 py-1.5 text-sm hover:bg-white hover:text-[#0B4A6E] shadow-sm",
    blue: "bg-white text-[#0B4A6E] px-4 py-1.5 text-sm border border-[#0B4A6E] hover:bg-[#0c628f] hover:text-white shadow-sm",
