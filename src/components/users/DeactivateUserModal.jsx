    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-[2rem] p-8 max-w-md w-full shadow-xl">
        ...
        <p className="text-gray-800 mb-8 leading-relaxed text-[15px]">
          {user.firstName} {user.lastName}'s account will be deactivated and
          will no longer have access to the system, while its records and
          activity history are retained.
        </p>
