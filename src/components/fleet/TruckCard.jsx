...
export default function TruckCard({ truck, onClick }) {
  ...
  return (
    ...
    >
      {/* CARD HEADER PILL */}
      <div className="bg-[#BAE6FD]/70 group-hover:bg-[#FEECA5] rounded-xl px-3.5 py-2.5 flex items-center justify-between gap-2 mb-3 text-[#0A4B6E] group-hover:text-[#854D0E] transition-all duration-200">
      ...
      <div className="flex items-center justify-between mt-auto pt-1 px-0.5">
        <Badge variant={getStatusVariant(normalizedStatus)} className="px-3.5 py-1 text-[10.5px]">
          {normalizedStatus || "ACTIVE"}
        </Badge>

        <div className="w-8 h-8 rounded-full bg-[#BAE6FD]/70 group-hover:bg-[#FEECA5] flex items-center justify-center text-[#0A4B6E] group-hover:text-[#854D0E] transition-all duration-200">
